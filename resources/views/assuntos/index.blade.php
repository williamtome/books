...
@section('content')
    ...
    <div>
        ...
        <a href="{{ route('assuntos.cadastro') }}" class="btn btn-primary">Cadastrar</a>
    </div>

    <ul>
        @foreach($assuntos as $assunto)
            <li>{{ $assunto->Descricao }}</li>
            <a href="{{ route('assuntos.editar', $assunto->CodAs) }}" class="btn btn-primary">Alterar</a>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Excluir Assunto</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('assuntos.excluir', $assunto->CodAs) }}" method="post">
                                @csrf
                                @method('DELETE')
